      ...
      <TouchableOpacity key={item.id} onPress={() => this._openArticle(item)}>
        <View style={styles.itemOneContainer}>
          <View style={styles.itemOneImageContainer}>
            <Image style={styles.itemOneImage} resizeMethod='resize' source={{ uri: item.image }} />
          </View>
  ...
  renderRowTwo = ({ item }) => (
    ...
    >
      <View style={styles.itemTwoContent}>
        <Image style={styles.itemTwoImage} resizeMethod='resize' source={{ uri: item.image }} />
  ...
  renderRowThree = ({ item }) => (
    ...
    >
      <View style={styles.itemThreeSubContainer}>
        <Image source={{ uri: item.image }} resizeMethod='resize' style={styles.itemThreeImage} />
